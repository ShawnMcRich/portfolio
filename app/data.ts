...
export const projects: Record<ProjectSlug, Project> = {
  apex: {
    ...
    metrics: [
      ...
      { value: "500+", label: t("crypto markets supported", "بازار رمزارز تحت پوشش") },
    ],
    context: t(
  ...
  vibe: {
    ...
    metrics: [
      { value: "1.4MB → 165kB", label: t("main bundle reduction", "کاهش باندل اصلی") },
      { value: "32", label: t("auth test cases", "تست احراز هویت") },
      { value: "22", label: t("traceable requirements", "نیازمندی قابل ردیابی") },
      { value: "360+", label: t("authored commits inspected", "کامیت ثبت شده در بررسی مخزن"), note: t("supporting evidence, not a success metric", "شاهد حجم کار، نه معیار موفقیت محصول") },
    ],
  ...
  "first-choice": {
    ...
    metrics: [
      ...
      { value: "9.6s → 2.8s", label: t("mobile LCP", "زمان LCP موبایل") },
  ...
  mrm: {
    ...
    metrics: [
      { value: "~40", label: t("people used it", "نفر از آن استفاده کردند") },
      { value: "0", label: t("required public-cloud services", "وابستگی اجباری به سرویس ابری عمومی") },
      { value: "1", label: t("self-hosted application service", "سرویس خودمیزبان اصلی") },
      { value: "Until return", label: t("used through the shutdown", "استفاده تا بازگشت اینترنت") },
    ],
